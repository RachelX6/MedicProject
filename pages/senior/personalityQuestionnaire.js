...
export default function SeniorQuestionnaire() {
    ...
    useEffect(() => {
        ...
        const totalQs = questionData["senior"].reduce(
    ...
    async function handleSubmit(e) {
        ...
        questionData["senior"].forEach((group) => {
            const key = group.key;
            let sum = 0;
    ...
    const flatQuestions = questionData["senior"].flatMap((group) => group.questions);

    return (
        <div style={containerStyle}>
            <form onSubmit={handleSubmit}>
                <h1 style={headerStyle}>Questionnaire for Seniors</h1>
                <p style={descStyle}>
